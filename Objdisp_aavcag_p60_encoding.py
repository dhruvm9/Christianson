...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 19 09:09:28 2025
...
data_directory = '/media/DataDhruv/Recordings/Christianson/AAVCAG_P60/Encoding'
...
### COHORT3 MALE
    ...
    if sex == 'M': # and len(mousename) == 4:
        ...
        rectL_inner = patches.Rectangle((x_objL - 45, y_objL - 25), 83, 142, linewidth=1, edgecolor='g', facecolor='none')
        rectL = patches.Rectangle((x_objL - 61.5, y_objL - 41.5), 116, 175, linewidth=1, edgecolor='b', facecolor='none')

        rectR_inner = patches.Rectangle((x_objR - 50, y_objR - 25), 83, 140, linewidth=1, edgecolor='g', facecolor='none')
        rectR = patches.Rectangle((x_objR - 66.5, y_objR - 41.5), 116, 173, linewidth=1, edgecolor='b', facecolor='none')
...
left_wt_m = [25.466703668, 51.466715661,	8.266694669, 6.700013001, 46.066722667, 84.200090998, 20.266696666, 89.533418335, 	
             69.200070998, 29.500034998, 59.900083, 54.666732668, 72.63339433, 72.766755668, 59.200060999]

right_wt_m = [55.266733667, 44.700047999, 7.100016998, 9.033352336, 43.333380331, 82.933415329, 35.733372337, 77.300084998,
              95.233422333, 55.766726667, 75.933420334, 53.033400332, 79.566753662, 47.700073006, 87.966761665]

left_ko_m = [56.166743671, 66.366744664, 43.400038001, 87.633430335, 109.266759667, 72.333404334, 67.466730665, 27.900029998,
             67.800067003, 71.300084999]

right_ko_m = [21.233359335, 116.633430334, 81.000054998, 95.733428332, 78.53341133, 69.466726662, 87.100075997, 96.000068999,
              80.466742665, 50.566729664]
