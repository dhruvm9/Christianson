...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 13 10:31:16 2025
...
data_directory = '/media/DataDhruv/Recordings/Christianson/aavpilot/recall'
...
### COHORT3 MALE
    ...
    if sex == 'M':
        ...
        rectL_inner = patches.Rectangle((x_objL - 60, y_objL - 80), 130, 230, linewidth=1, edgecolor='g', facecolor='none')
        rectL = patches.Rectangle((x_objL - 101.15, y_objL - 121.15), 212.3, 312.3, linewidth=1, edgecolor='b', facecolor='none')
