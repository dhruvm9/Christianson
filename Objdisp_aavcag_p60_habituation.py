...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug 18 12:06:52 2025
...
data_directory = '/media/DataDhruv/Recordings/Christianson/AAVCAG_P60/H3'
...
#%% Compute distance between positions of consecutive frames 
    ...
    tot_dist = (sum(distance) * 60) / 660 ##approx conversion to cm
