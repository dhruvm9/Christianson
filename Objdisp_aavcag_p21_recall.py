...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 15 09:33:27 2025
...
data_directory = '/media/DataDhruv/Recordings/Christianson/AAVCAG_P21/Recall'
...
### COHORT3 MALE
    ...
    if sex == 'M':
        ...
        if (dispobj == 'right') and mousename not in ['781', '782', '1319', '1322']:    
    
            rectR_inner = patches.Rectangle((x_objL - 65, y_objL - 55), 120, 120, linewidth=1, edgecolor='g', facecolor='none')
            rectR = patches.Rectangle((x_objL - 105, y_objL - 76), 183, 183, linewidth=1, edgecolor='b', facecolor='none')
            
            rectL_inner = patches.Rectangle((x_objR - 65, y_objR - 60), 120, 120, linewidth=1, edgecolor='g', facecolor='none')
            rectL = patches.Rectangle((x_objR - 86, y_objR - 100), 183, 190, linewidth=1, edgecolor='b', facecolor='none')
            
        elif (dispobj == 'right') and mousename in ['781', '782', '1319', '1322']:    
    
            rectR_inner = patches.Rectangle((x_objL - 65, y_objL - 55), 120, 120, linewidth=1, edgecolor='g', facecolor='none')
            rectR = patches.Rectangle((x_objL - 105, y_objL - 80), 188, 187, linewidth=1, edgecolor='b', facecolor='none')
            
            rectL_inner = patches.Rectangle((x_objR - 65, y_objR - 60), 125, 125, linewidth=1, edgecolor='g', facecolor='none')
            rectL = patches.Rectangle((x_objR - 86, y_objR - 100), 183, 190, linewidth=1, edgecolor='b', facecolor='none')
                
        elif (dispobj == 'left') and (mousename not in ['1326', '1331', '1337', '1341']): 
            
            rectL_inner = patches.Rectangle((x_objL - 65, y_objL - 60), 120, 130, linewidth=1, edgecolor='g', facecolor='none')
            rectL = patches.Rectangle((x_objL - 86, y_objL - 85), 165, 188, linewidth=1, edgecolor='b', facecolor='none')
            
            rectR_inner = patches.Rectangle((x_objR - 65, y_objR - 65), 120, 120, linewidth=1, edgecolor='g', facecolor='none')
            rectR = patches.Rectangle((x_objR - 101, y_objR - 105), 180, 195, linewidth=1, edgecolor='b', facecolor='none')
            
        elif (dispobj == 'left') and (mousename in ['1326', '1331', '1337']): 
            
            rectL_inner = patches.Rectangle((x_objL - 60, y_objL - 55), 120, 120, linewidth=1, edgecolor='g', facecolor='none')
            rectL = patches.Rectangle((x_objL - 85, y_objL - 81), 170, 188, linewidth=1, edgecolor='b', facecolor='none')
            
            rectR_inner = patches.Rectangle((x_objR - 65, y_objR - 60), 120, 115, linewidth=1, edgecolor='g', facecolor='none')
            rectR = patches.Rectangle((x_objR - 107, y_objR - 103), 183, 185, linewidth=1, edgecolor='b', facecolor='none')
            
        else: #elif (dispobj == 'left') and (mousename  == '1341'): 
            
            rectL_inner = patches.Rectangle((x_objL - 80, y_objL - 80), 120, 120, linewidth=1, edgecolor='g', facecolor='none')
            rectL = patches.Rectangle((x_objL - 101, y_objL - 105), 170, 190, linewidth=1, edgecolor='b', facecolor='none')
            
            rectR_inner = patches.Rectangle((x_objR - 65, y_objR - 65), 120, 120, linewidth=1, edgecolor='g', facecolor='none')
            rectR = patches.Rectangle((x_objR - 107, y_objR - 100), 183, 180, linewidth=1, edgecolor='b', facecolor='none')
...
#%%  
    ...
    if dispobj == 'left' and len(mousename) == 3:
        leftDI_wt.append(DI)
    elif dispobj == 'right' and len(mousename) == 3:
        rightDI_wt.append(DI)
    elif dispobj == 'left' and len(mousename) != 3:
        leftDI_ko.append(DI)
    else:
        rightDI_ko.append(DI)
